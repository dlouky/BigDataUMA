...
public class PruebaLibreriaV1 {
    public static void main(String[] args) {
        Libreria libreria = new Libreria(20);
        ...
        System.out.println(libreria);
            /*int numLibros = libreria.numLibros;
            System.out.println(numLibros + "---" +libreria.libros[numLibros]);//Pruebo si se borra el ultimo libro*/
        ...
        System.out.println("\nTamaño de array al final del ejercicio: " + libreria.getLength());
    }
}
